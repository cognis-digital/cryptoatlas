"""Native cognis-connect emit for cryptoatlas — forward findings to any platform.

Maps cryptoatlas's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    cryptoatlas ... --format json | cryptoatlas-emit --to stix
    cryptoatlas-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
